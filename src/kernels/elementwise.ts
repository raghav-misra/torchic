...
export function add(a: Float32Array, b: Float32Array, out: Float32Array, start: number, end: number) {
    for (let i = start; i < end; i++) {
        out[i] = a[i] + b[i];
    }
}

export function sub(a: Float32Array, b: Float32Array, out: Float32Array, start: number, end: number) {
    for (let i = start; i < end; i++) {
        out[i] = a[i] - b[i];
    }
}

export function mul(a: Float32Array, b: Float32Array, out: Float32Array, start: number, end: number) {
    for (let i = start; i < end; i++) {
        out[i] = a[i] * b[i];
    }
}

export function div(a: Float32Array, b: Float32Array, out: Float32Array, start: number, end: number) {
    for (let i = start; i < end; i++) {
        out[i] = a[i] / b[i];
    }
}
